#!/usr/bin/env node
/**
 * Writes build/manifest.json for Pulpo Connect (Dev).
 * Figma only accepts manifest.json on import — manifest.sync.json is the source template.
 * Uses build/ui.dev.html — NOT build/ui.html (Community plugin).
 */
...
console.log('Wrote build/manifest.json → Pulpo Connect (Dev), ui: ui.dev.html');
