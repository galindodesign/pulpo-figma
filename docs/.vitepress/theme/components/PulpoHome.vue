...
<template>
  <div class="pulpo-home">
    <section class="pulpo-hero">
      <PulpoIcon class="pulpo-hero__logo" :size="72" title="Pulpo" />
      <h1 class="pulpo-hero__title">Pulpo</h1>
      <p class="pulpo-hero__tagline">
