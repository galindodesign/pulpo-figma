...
The workflow [`.github/workflows/issue-notify.yml`](https://github.com/galindolala1990/growthlab-infigma/blob/main/.github/workflows/issue-notify.yml) runs on every new issue. If any secret is missing, it skips silently (no failure).

## 2. Contact page email (optional)

To show **Email us** on the [Contact](/contact) page and in the Figma plugin footer, set in [`site-constants.ts`](https://github.com/galindolala1990/growthlab-infigma/blob/main/site-constants.ts):
